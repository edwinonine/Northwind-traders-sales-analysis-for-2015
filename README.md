...
I had to carry out a correlation analysis with total sales (revenue), quantitynand total order to see if there are any relationship that exist between the variables, from my analysis it was perfect negative relationship.
