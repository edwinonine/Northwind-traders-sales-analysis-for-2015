...
## Actual Analysis
After carrying out descriptive analysias, i divided the analysis into two major parts, the first one majorly focus on sales (revenue) generated during the first quarter in 2015 some of the key performance indicators i used were Top 10 order by country, quantity order by month, revenue generated by month, Top 10 revenue by products, and lastly order by category. The last analysis focuses on product performances using total sales, order amd total quantity as key metrixs in deriving insights.
